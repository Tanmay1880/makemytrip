...
import { User, Mail, Phone, Shield, LogOut, Calendar, BadgeCheck } from 'lucide-react';
      ...
      <div className="card overflow-hidden mb-6">
        ...
        <div className="p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-sm font-medium text-gray-900">Account Status: Active</span>
          </div>
          ...
          <div className="space-y-4">
            {fields.map((field) => {
              ...
              return (
                <div key={field.label} className="flex items-center gap-3 pb-4 border-b border-gray-100 last:border-0">
